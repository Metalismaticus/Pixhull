...
export const STRINGS = {
  en: {
    ...
    'sheet.summaryGuessed': 'Found {n} drawings in a {w}×{h} sheet · their sizes say which view is which',
    'sheet.ignore': '— skip —',
    'sheet.cancel': 'Cancel',
    ...
    'views.edit': 'Paint this drawing (P)',
    'views.edited': 'Edited here; the model has not been rebuilt',
    ...
    'grid.viewsAhead': 'Drawings edited: {views} — the model has not seen them yet.',
    ...
    'view2d.toModel': 'Look at the model (P)',
    'view2d.toDrawing': 'Paint the drawings (P)',
    'view2d.take': 'Take it from the model',
    'view2d.blank': 'Blank {n}×{n} sheet',
    'view2d.empty': 'Nothing has been drawn for this view yet.',
    'view2d.noModel': 'There is no model to project from — start from a blank sheet.',
    'view2d.building': 'The build is running; a model still being carved cannot be projected.',
    'view2d.takeCost': 'The model is projected back through this view: about {s} s on a {n}³ grid.',
    'view2d.takeNote': 'A projection carries the silhouette and the colours this view can see — not the edit history.',
    'view2d.projecting': 'Projecting the view: {view}',
    'view2d.taken': 'Taken from the model: {view} · pixels {n}',
    'view2d.takenEmpty': 'This view sees no voxel of the model — the sheet came back empty.',
    'view2d.blankMade': 'Blank sheet {n}×{n} for {view}',
    'view2d.exact': '{w}×{h} px · grid {n} · one pixel per cell',
    'view2d.scaled': '{w}×{h} px · grid {n} · one cell = {k} px',
    'view2d.hover': '{view} · {x}, {y} · {hex}',
    'view2d.hoverEmpty': '{view} · {x}, {y} · transparent',
    'view2d.stroke': '{view} · pixels changed: {n}',
    'view2d.pickEmpty': 'A transparent pixel has no colour to pick.',
    'view2d.toolsOff': 'A drawing has no voxels: Add, Box and the X mirror work on the model.',
    'view2d.mapOff': 'The disagreement map draws on the model; painting a drawing turns it off.',
    'view2d.gridHint': 'Cell grid appears from {min}× — below that the lines merge; now {now}×.',
    ...
    'view.map': 'Disagreement map',
    'view.mapHint': 'Shows where the six drawings give one voxel different colours. The model itself does not change; face shading is off while the map is on.',
    'view.mapHover': 'Hover the model to see which views disagree and what colours they give.',
    'view.mapCount': '{n} of {total} disputed · {pct}%',
    'view.mapNone': 'No disputed voxels: every view agrees.',
    'view.mapNoModel': 'There is no model yet: the map is computed during the build.',
    'view.mapBuilding': 'The build is running — the map arrives when it finishes.',
    'view.mapNoData': 'This project was loaded ready-made: the map is computed during the build. Build the model again.',
    'view.mapBandMax': 'different colour',
    'view.mapBandHigh': 'strong',
    'view.mapBandMid': 'clear',
    'view.mapBandLow': 'slight',
    'view.mapBandAgree': 'agree',
    'view.mapBandNone': 'one view only',
    'edit.mapReadOnly': 'The disagreement map is a viewing mode. Clear the checkbox to edit the model.',
    'export.mapNote': 'Exports use the model’s own colours, not the map.',
    'model.smoothMapNote': 'While the map is on the viewport shows voxel faces; exports are unaffected.',
    'status.mapOn': 'Disagreement map: {n} disputed voxels of {total}',
    'status.mapHit': '{x},{y},{z} · {a} ↔ {b} · ΔE {d} · {ha} ↔ {hb}',
    'status.mapLonely': '{x},{y},{z} · seen by {a} only — nothing to compare with',
    'status.mapUnknown': '{x},{y},{z} · added after the build — not in the map',
    ...
    'export.views': 'Export the six views',
    'export.slices': 'Export PNG slices (sprite stacking)',
    'export.viewsNote': 'One PNG with all six drawings, ready to paint on and drop back in through “Slice a sheet”. It carries the silhouette and the colours a view can see — not the edit history, and not a face no view looks at. Read it back with the gutter at 2 or more.',
    'export.slicesNote': 'A sheet of horizontal layers — the lowest one first, then left to right, row by row — plus a JSON naming which cell holds which layer. That is what an engine that stacks sprites expects. One colour per pixel, and it is the voxel’s top face: a stack is only ever seen from above, and that is the same rule the .vox export uses. Voxels inside the model keep no colour of their own; nothing ever sees them.',
    'export.slicesTooBig': 'Not available: the sheet would be {w}×{h} px and {max} per side is the ceiling a browser canvas can hold. Rebuild on a smaller grid to get slices.',
    ...
    'status.exportedViews': 'Exported {n} views on a {w}×{h} px sheet',
    'status.exportedSlices': 'Exported {n} slices of {w}×{h} px on a {sw}×{sh} sheet, {c} colours',
    ...
    'edit.drawingWarning': 'This throws away drawings you painted here, and they are not in the model yet.',
    'edit.drawingConfirm': 'Discard those drawings?',
    'edit.drawingKept': 'Drawings kept — nothing was replaced.',
    'tool.orbit': 'Orbit',
    'tool.paint': 'Paint',
    'tool.fill': 'Fill',
    'tool.erase': 'Erase',
    ...
    'edit.bakeHeading': 'Bake into the model',
    'edit.bakeOutline': 'Bake outline',
    'edit.bakeLight': 'Bake light',
    'edit.bakeThickness': 'Outline thickness',
    'edit.bakeUseColor': 'Outline in the selected colour',
    'edit.bakeReady': 'Would repaint {faces} faces and add {n} colours — {free} slots free.',
    'edit.bakePartial': 'At least {faces} faces and {n} new colours — the model is too large to finish counting; {free} slots free.',
    'edit.bakeOverflow': '{faces} faces need {n} new colours but only {free} slots are free — the rest will land on the nearest colour already in the palette.',
    'edit.bakeOverflowPartial': 'At least {faces} faces and {n} new colours against {free} free slots — it will not fit, and the rest will land on the nearest colour already in the palette.',
    'edit.bakeNothing': 'Nothing to bake — every face already wears the colour this would give it.',
    'edit.bakeNoModel': 'No model yet — baking writes into the model’s face bytes, so it needs one.',
    'edit.bakeBuilding': 'The build is running — baking waits until it finishes.',
    'edit.bakeStale': 'Not counted yet — the count runs when you reach for these buttons.',
    'edit.bakeHint': 'Baked colour lives in the model, so it goes into .obj, .glb and .vox. Each press bakes on top of the last one, so a second light bake darkens an already darkened model. Ctrl+Z takes a whole bake back.',
    ...
    'status.bakedOutline': 'Outline baked: {faces} faces, {colours} colours, {added} of them new — {free} slots free',
    'status.bakedLight': 'Light baked: {faces} faces, {colours} colours, {added} of them new — {free} slots free',
    'status.bakedNothing': 'Nothing changed — every face already wears the colour this would give it',
    'status.bakeShadeOff': 'Face shading turned off in the viewport — the light is in the model now',
  ...
  ru: {
    ...
    'sheet.summaryGuessed': 'Найдено рисунков: {n}, лист {w}×{h} · размеры сами говорят, где какой вид',
    ...
    'views.edit': 'Править этот рисунок (P)',
    'views.edited': 'Правлен здесь, модель ещё не пересобрана',
    ...
    'grid.viewsAhead': 'Правлены рисунки: {views} — модель их ещё не видела.',
    ...
    'view2d.toModel': 'Смотреть на модель (P)',
    'view2d.toDrawing': 'Править рисунки (P)',
    'view2d.take': 'Взять из модели',
    'view2d.blank': 'Чистый лист {n}×{n}',
    'view2d.empty': 'Для этого вида ещё ничего не нарисовано.',
    'view2d.noModel': 'Проецировать не из чего: модели нет — начните с чистого листа.',
    'view2d.building': 'Идёт сборка: модель, которую ещё режут, спроецировать нельзя.',
    'view2d.takeCost': 'Модель проецируется обратно через этот вид: около {s} с на сетке {n}³.',
    'view2d.takeNote': 'Проекция везёт силуэт и цвета, которые видно с этой стороны, — но не историю правок.',
    'view2d.projecting': 'Проекция вида: {view}',
    'view2d.taken': 'Взято из модели: {view} · пикселей {n}',
    'view2d.takenEmpty': 'С этой стороны модели не видно ни одного вокселя — лист вернулся пустым.',
    'view2d.blankMade': 'Чистый лист {n}×{n} для вида {view}',
    'view2d.exact': '{w}×{h} px · сетка {n} · пиксель в клетку',
    'view2d.scaled': '{w}×{h} px · сетка {n} · 1 клетка = {k} px',
    'view2d.hover': '{view} · {x}, {y} · {hex}',
    'view2d.hoverEmpty': '{view} · {x}, {y} · прозрачно',
    'view2d.stroke': '{view} · изменено пикселей: {n}',
    'view2d.pickEmpty': 'У прозрачного пикселя цвета нет.',
    'view2d.toolsOff': 'У рисунка нет вокселей: «Добавить», «Бокс» и зеркало по X работают по модели.',
    'view2d.mapOff': 'Карта расхождений рисует по модели — правка рисунка её выключает.',
    'view2d.gridHint': 'Решётка клеток появляется с {min}× — ниже линии сливаются; сейчас {now}×.',
    ...
    'view.map': 'Карта расхождений',
    'view.mapHint': 'Показывает, где шесть рисунков дают одному вокселю разный цвет. Модель не меняется; затенение граней в этом режиме не применяется.',
    'view.mapHover': 'Наведите на модель — покажет, какие виды спорят и какие цвета дают.',
    'view.mapCount': 'Спорят {n} из {total} · {pct}%',
    'view.mapNone': 'Спорящих вокселей нет: все виды согласны.',
    'view.mapNoModel': 'Модели ещё нет: карта считается при сборке.',
    'view.mapBuilding': 'Идёт сборка — карта появится, когда она закончится.',
    'view.mapNoData': 'Проект загружен готовым: карта считается при сборке. Соберите модель заново.',
    'view.mapBandMax': 'другой цвет',
    'view.mapBandHigh': 'сильное',
    'view.mapBandMid': 'заметное',
    'view.mapBandLow': 'слабое',
    'view.mapBandAgree': 'согласны',
    'view.mapBandNone': 'один вид',
    'edit.mapReadOnly': 'Карта расхождений — режим просмотра. Снимите флажок, чтобы править модель.',
    'export.mapNote': 'Экспорт идёт в цветах модели, а не карты.',
    'model.smoothMapNote': 'Пока карта включена, в окне видны воксельные грани; на экспорт это не влияет.',
    'status.mapOn': 'Карта расхождений: спорных вокселей {n} из {total}',
    'status.mapHit': '{x},{y},{z} · {a} ↔ {b} · ΔE {d} · {ha} ↔ {hb}',
    'status.mapLonely': '{x},{y},{z} · виден только видом {a} — сравнить не с чем',
    'status.mapUnknown': '{x},{y},{z} · появился после сборки — в карте его нет',
    ...
    'export.views': 'Экспорт шести видов',
    'export.slices': 'Экспорт срезами PNG (sprite stacking)',
    'export.viewsNote': 'Один PNG со всеми шестью рисунками: правьте в своём редакторе и возвращайте через «Нарезать лист». Круг возит силуэт и те цвета, которые видно снаружи, — но не историю правок и не грани, на которые не смотрит ни один вид. Загружая обратно, ставьте промежуток 2 или больше.',
    'export.slicesNote': 'Лист горизонтальных срезов — первый самый нижний, дальше слева направо ряд за рядом, — и JSON, который называет, в какой ячейке какой слой. Этого ждёт движок со сложением спрайтов. Цвет в пикселе один, и это верхняя грань вокселя: стопку видно только сверху, и по тому же правилу схлопывает цвет экспорт .vox. Воксели внутри модели своего цвета не несут — их никто не видит.',
    'export.slicesTooBig': 'Недоступно: лист вышел бы {w}×{h} пкс, а {max} по стороне — предел, который держит канвас браузера. Нужны срезы — соберите на меньшей сетке.',
    ...
    'status.exportedViews': 'Экспортировано {n} видов листом {w}×{h} пкс',
    'status.exportedSlices': 'Экспортировано {n} срезов по {w}×{h} пкс листом {sw}×{sh}, цветов {c}',
    ...
    'edit.drawingWarning': 'Это выбросит нарисованное здесь, а в модель оно ещё не попало.',
    'edit.drawingConfirm': 'Выбросить эти рисунки?',
    'edit.drawingKept': 'Рисунки сохранены — ничего не заменено.',
    'tool.orbit': 'Вращение',
    'tool.paint': 'Кисть',
    'tool.fill': 'Заливка',
    'tool.erase': 'Стирка',
    ...
    'edit.bakeHeading': 'Запечь в модель',
    'edit.bakeOutline': 'Запечь обводку',
    'edit.bakeLight': 'Запечь свет',
    'edit.bakeThickness': 'Толщина обводки',
    'edit.bakeUseColor': 'Обводка выбранным цветом',
    'edit.bakeReady': 'Перекрасит граней: {faces}, добавит цветов: {n} — свободных слотов {free}.',
    'edit.bakePartial': 'Не меньше {faces} граней и {n} новых цветов — модель слишком велика, чтобы досчитать; свободных слотов {free}.',
    'edit.bakeOverflow': 'Граней {faces}, новых цветов нужно {n}, а свободных слотов {free} — остальные сядут на ближайший цвет, который в палитре уже есть.',
    'edit.bakeOverflowPartial': 'Не меньше {faces} граней и {n} новых цветов против {free} свободных слотов — не поместится, остальные сядут на ближайший цвет, который в палитре уже есть.',
    'edit.bakeNothing': 'Запекать нечего — на каждой грани уже тот цвет, который получился бы.',
    'edit.bakeNoModel': 'Модели пока нет — запекание пишет в байты граней модели, без неё не во что.',
    'edit.bakeBuilding': 'Идёт сборка — запекание подождёт, пока она кончится.',
    'edit.bakeStale': 'Ещё не сосчитано — счёт идёт при наведении на эти кнопки.',
    'edit.bakeHint': 'Запечённый цвет живёт в модели, поэтому попадает в .obj, .glb и .vox. Каждое нажатие запекает поверх предыдущего: второе запекание света темнит уже затемнённую модель. Ctrl+Z отменяет запекание целиком.',
    ...
    'status.bakedOutline': 'Обводка запечена: граней {faces}, цветов {colours}, из них новых {added} — свободных слотов {free}',
    'status.bakedLight': 'Свет запечён: граней {faces}, цветов {colours}, из них новых {added} — свободных слотов {free}',
    'status.bakedNothing': 'Ничего не изменилось — на каждой грани уже тот цвет, который получился бы',
    'status.bakeShadeOff': 'Затенение граней в окне выключено — свет теперь в самой модели',
