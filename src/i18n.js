...
const STRINGS = {
  en: {
    ...
    'model.heading': 'Model',
    'model.smooth': 'Smooth mesh, not cubes',
    'model.relax': 'Rounding',
    'model.smoothHint': 'Builds a rounded low-poly shell over the same voxels (surface nets), keeping every face colour. Grid resolution still sets how much detail there is.',
  ...
  ru: {
    ...
    'model.smooth': 'Гладкий меш вместо кубиков',
    'model.relax': 'Скругление',
    'model.smoothHint': 'Строит округлённую low-poly оболочку по тем же вокселям (surface nets), сохраняя цвет каждой грани. Количество деталей по-прежнему задаёт сетка.',
