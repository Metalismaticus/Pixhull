...
const STRINGS = {
  en: {
    ...
    'dl.toolExport': "Writes OBJ (optionally as a smooth mesh instead of cubes), .vox for MagicaVoxel, or a turnaround sheet with per-frame pivots in JSON.",
  ...
  ru: {
    ...
    'dl.toolExport': "Пишет OBJ (по желанию гладким мешем вместо кубиков), .vox для MagicaVoxel или лист оборота с пивотами каждого кадра в JSON.",
