...
export const STRINGS = {
  en: {
    ...
    'view.bounds': 'Show the grid',
    'view.boundsHint': 'The cell grid appears under the cursor from {min}× zoom; now {now}×.',
    ...
    'status.building': 'Building — {stage} · {pct}%',
    'status.buildFailed': 'The build failed: {err}',
    'status.editBlocked': 'The model is still being built — edits would be thrown away when it lands.',
    'build.progress': 'Build progress',
    'build.sample': 'reading the drawings',
    'build.intersect': 'carving',
    'build.field': 'finding the surface',
    'build.paint': 'painting faces',
    'build.slopes': 'repainting slopes',
    'build.infer': 'filling gaps',
    'build.geometry': 'packing geometry',
    ...
    'edit.mergeColors': 'Merge near-duplicates',
    ...
    'tool.box': 'Box',
    'edit.boxHint': 'Drag a rectangle on a face, then drag the outline’s sides to set its depth. The block stays until you apply it or drop it with Esc.',
    'edit.selection': 'Selection',
    'edit.boxFill': 'Fill block',
    'edit.boxDelete': 'Delete',
    'edit.boxPaint': 'Paint',
    'edit.boxClear': 'Clear selection',
    'edit.boxFigures': '{solid} solid · {empty} empty',
    'edit.boxKeys': 'Esc drops the block, Enter fills it, Delete removes it.',
    'edit.boxEmptyNote': 'The block holds no voxels — there is nothing to delete or paint.',
    'edit.boxFullNote': 'The block is solid already — there is nothing to fill.',
    'edit.boxBuildingNote': 'The build is running — the block waits until it finishes.',
    'edit.boxTooBig': 'Over 2 000 000 cells — the count runs on a smaller block.',
    'edit.boxFillTitle': '{w}×{h}×{d} · {n} voxels will be added',
    'edit.boxDeleteTitle': '{w}×{h}×{d} · {n} voxels will be removed',
    'edit.boxPaintTitle': '{w}×{h}×{d} · {n} voxels change colour',
    ...
    'edit.brushOff': 'Fill and Pick work on one face, and the Box takes its depth from the drag — brush size changes nothing here.',
    ...
    'edit.paletteFullHint': 'The palette holds 255 colours. Merge near-duplicates to free slots; until then a new colour snaps to the nearest.',
    'edit.mergeReady': '{n} slots hold a colour indistinguishable from another slot’s — merging frees them.',
    'edit.mergeNone': 'Nothing to merge — every colour is distinguishable from the rest.',
    'edit.mergeFree': '{n} slots are free for new colours.',
    'edit.mergeNoModel': 'No model yet — merging rewrites the model’s face bytes, so it needs one.',
    'edit.mergeBuilding': 'The build is running — merging waits until it finishes.',
    ...
    'status.boxSize': 'Block {w}×{h}×{d} · {n} cells',
    'status.boxFilled': 'Filled {n} voxels · {w}×{h}×{d}',
    'status.boxDeleted': 'Removed {n} voxels · {w}×{h}×{d}',
    'status.boxPainted': 'Repainted {n} faces · slot {i}',
    'status.boxNothing': 'Nothing changed — the block is already like that.',
    'status.undone': 'Undone',
    'status.redone': 'Redone',
    'status.nothingToUndo': 'Nothing to undo',
    'status.colorAdded': 'Palette now has {n} colours',
    'status.paletteFull': 'Palette is full at 255 colours — merge near-duplicates to free slots',
    'status.colorsMerged': 'Merged {n} colours into {g} — {faces} faces repainted, {free} slots free',
    'status.noNearDuplicates': 'Nothing to merge — no two colours are that close',
    'status.noModel': 'No model yet — build one first',
    'status.buildRunning': 'The build is running — this waits for it',
  ...
  ru: {
    ...
    'view.bounds': 'Показывать сетку',
    'view.boundsHint': 'Решётка по клеткам видна под курсором от {min}× увеличения; сейчас {now}×.',
    ...
    'status.building': 'Сборка — {stage} · {pct}%',
    'status.buildFailed': 'Сборка не удалась: {err}',
    'status.editBlocked': 'Модель ещё собирается — правки пропали бы, когда она придёт.',
    'build.progress': 'Ход сборки',
    'build.sample': 'читаем рисунки',
    'build.intersect': 'вырезаем',
    'build.field': 'ищем поверхность',
    'build.paint': 'красим грани',
    'build.slopes': 'перекрашиваем наклонные',
    'build.infer': 'заполняем пробелы',
    'build.geometry': 'пакуем геометрию',
    ...
    'edit.mergeColors': 'Слить почти-дубликаты',
    ...
    'tool.pick': 'Пипетка',
    'tool.box': 'Бокс',
    'edit.boxHint': 'Протяните рамку по грани, потом тяните стороны контура — так задаётся глубина. Блок остаётся, пока его не применили или не сняли клавишей Esc.',
    'edit.selection': 'Выделение',
    'edit.boxFill': 'Залить',
    'edit.boxDelete': 'Удалить',
    'edit.boxPaint': 'Покрасить',
    'edit.boxClear': 'Снять выделение',
    'edit.boxFigures': 'занято {solid} · пусто {empty}',
    'edit.boxKeys': 'Esc снимает блок, Enter заливает, Delete удаляет.',
    'edit.boxEmptyNote': 'В блоке нет ни одного вокселя — удалять и красить нечего.',
    'edit.boxFullNote': 'Блок уже заполнен целиком — заливать нечего.',
    'edit.boxBuildingNote': 'Идёт сборка — блок подождёт, пока она закончится.',
    'edit.boxTooBig': 'Больше 2 000 000 клеток — счёт идёт на блоке поменьше.',
    'edit.boxFillTitle': '{w}×{h}×{d} · прибавится вокселей: {n}',
    'edit.boxDeleteTitle': '{w}×{h}×{d} · исчезнет вокселей: {n}',
    'edit.boxPaintTitle': '{w}×{h}×{d} · сменят цвет вокселей: {n}',
    ...
    'edit.brushOff': 'Заливка и пипетка работают по одной грани, а бокс берёт глубину из самой протяжки — размер кисти ни на что из этого не влияет.',
    ...
    'edit.paletteFullHint': 'В палитре 255 цветов. Слейте почти-дубликаты, чтобы освободить слоты; пока этого нет, новый цвет примагнитится к ближайшему.',
    'edit.mergeReady': 'Слотов, чей цвет неотличим от цвета другого слота: {n} — слияние их освободит.',
    'edit.mergeNone': 'Сливать нечего — все цвета различимы.',
    'edit.mergeFree': 'Свободных слотов для новых цветов: {n}.',
    'edit.mergeNoModel': 'Модели пока нет — слияние переписывает байты граней модели, без неё не с чем.',
    'edit.mergeBuilding': 'Идёт сборка — слияние подождёт, пока она кончится.',
    ...
    'status.boxSize': 'Блок {w}×{h}×{d} · клеток {n}',
    'status.boxFilled': 'Залито вокселей: {n} · {w}×{h}×{d}',
    'status.boxDeleted': 'Удалено вокселей: {n} · {w}×{h}×{d}',
    'status.boxPainted': 'Перекрашено граней: {n} · слот {i}',
    'status.boxNothing': 'Ничего не изменилось — блок уже такой.',
    ...
    'status.paletteFull': 'Палитра заполнена: 255 цветов — слейте почти-дубликаты, чтобы освободить слоты',
    'status.colorsMerged': 'Слито цветов: {n} в {g} — перекрашено граней: {faces}, свободно слотов: {free}',
    'status.noNearDuplicates': 'Сливать нечего — настолько близких цветов нет',
    'status.noModel': 'Модели пока нет — сначала соберите её',
    'status.buildRunning': 'Идёт сборка — это подождёт её',
