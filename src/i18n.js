...
export const STRINGS = {
  en: {
    ...
    'edit.mergeReady': '{n} slots hold a colour another slot already has — merging frees them.',
  ...
  ru: {
    ...
    'edit.mergeColors': 'Слить дубликаты',
    ...
    'edit.mergeReady': 'Слотов с цветом, который уже есть в другом слоте: {n} — слияние их освободит.',
